...
type HelloClient interface {
	...
	// 服务端流式RPC
	ServerStreamHello(ctx context.Context, in *Request, opts ...grpc.CallOption) (Hello_ServerStreamHelloClient, error)
	// 客户端流式RPC
...
func (c *helloClient) ServerStreamHello(ctx context.Context, in *Request, opts ...grpc.CallOption) (Hello_ServerStreamHelloClient, error) {
...
func (x *helloServerStreamHelloClient) Recv() (*Response, error) {
	m := new(Response)
...
func (x *helloClientStreamHelloClient) Send(m *Request) error {
	return x.ClientStream.SendMsg(m)
}

func (x *helloClientStreamHelloClient) CloseAndRecv() (*Response, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
	m := new(Response)
...
func (x *helloBudiStreamHelloClient) Send(m *Request) error {
	return x.ClientStream.SendMsg(m)
}

func (x *helloBudiStreamHelloClient) Recv() (*Response, error) {
	m := new(Response)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
type HelloServer interface {
	...
	// 服务端流式RPC
	ServerStreamHello(*Request, Hello_ServerStreamHelloServer) error
	// 客户端流式RPC
...
func (UnimplementedHelloServer) ServerStreamHello(*Request, Hello_ServerStreamHelloServer) error {
...
func (x *helloServerStreamHelloServer) Send(m *Response) error {
...
func (x *helloClientStreamHelloServer) SendAndClose(m *Response) error {
	return x.ServerStream.SendMsg(m)
}

func (x *helloClientStreamHelloServer) Recv() (*Request, error) {
	m := new(Request)
...
func (x *helloBudiStreamHelloServer) Send(m *Response) error {
	return x.ServerStream.SendMsg(m)
}

func (x *helloBudiStreamHelloServer) Recv() (*Request, error) {
	m := new(Request)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
